		...
		switch (msg.$) {
			...
			case 'GotText':
				...
				if (result.$ === 'Ok') {
					...
					if (_n2.$ === 'Ok') {
						var output = _n2.a;
						return (output.state === '1') ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : (((output.state === '2') || (output.state === '5')) ? _Utils_Tuple2(model, elm$core$Platform$Cmd$none) : _Utils_Tuple2(model, elm$core$Platform$Cmd$none));
					} else {
