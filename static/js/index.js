...
var author$project$Main$initCode = elm$http$Http$get(
	{
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		{code: '', jsonReqState: author$project$Main$Loading, loadState: author$project$Main$Loading, outPut: '', parseJson: author$project$Main$Loading},
	...
	function (msg, model) {
		switch (msg.$) {
			case 'GotText':
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{code: fullText, loadState: author$project$Main$Success}),
			...
			default:
				...
				if (result.$ === 'Ok') {
					var fullText = result.a;
					var _n3 = A2(elm$json$Json$Decode$decodeString, author$project$Main$outputDecoder, fullText);
					if (_n3.$ === 'Ok') {
						var output = _n3.a;
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{jsonReqState: author$project$Main$Success, outPut: output, parseJson: author$project$Main$Success}),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{jsonReqState: author$project$Main$Success, parseJson: author$project$Main$Fail}),
							elm$core$Platform$Cmd$none);
					}
				} else {
					return _Utils_Tuple2(
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text('网络加载失败，请稍后重试....')
									]))
							]))
					]));
	}
