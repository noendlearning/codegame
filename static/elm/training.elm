                ...
                [ div [ class "cg-navigation-subtabs" ]
                  [ div [ class "cg-navigation-subtabs_content" ]
                    [ div [ class "cg-subtabs" ]
                      [ a [ href "/training", class "subtab selected" ]
                        [ span []
                          [ text "Puzzles" ]
                        , div [ class "hover-bar" ]
                          []
                        ]
                      , a [ href "/training", class "subtab" ]
                        [ span []
                          [ text "Sponsored Puzzles" ]
                        , div [ class "hover-bar" ]
                          []
                        ]
                      ]
                  ...
                  [ div [ class "container" ]
                    [ div [ class "content large-section" ]
                              ...
                              [ div [ class "puzzle-wrapper" ]
                                ...
                                , div [ class "puzzle-footer-details" ]
                                  [ div [ class "footer-content" ]
                                    [ a [ class "footer-topic", href "/learn/conditions" ]
                                      [ text "Conditions" ]
                                    ]
                      ...
                      , div [ class "cg-puzzles-section" ]
                        ...
                        , a [ class "sub-pane", href "/training/easy" ]
